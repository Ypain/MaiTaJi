...
export default function BabyQAPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('/api/baby-qa', {
        method: 'POST',
        ...
        <div className="max-w-2xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">专业解答育儿过程中的疑问</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <CardContent className="pt-6 space-y-5">
            <div className="space-y-2">
              <Textarea
                ...
                className="border-indigo-200 focus:border-indigo-400 focus:ring-indigo-400 min-h-[120px]"
                maxLength={500}
              />
            </div>
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-medium py-6 text-base disabled:opacity-50"
            >
              {loading ? (
