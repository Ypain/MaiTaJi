...
export default function GrowthPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 pb-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-teal-500 to-green-500 text-white">
        <div className="max-w-2xl mx-auto px-4 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">发育记录</h1>
              <p className="text-sm text-white/80">记录宝宝身高体重发育曲线</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-4">
        <Card className="border-0 shadow-lg">
          <CardContent className="pt-8 pb-8 text-center">
            <Construction className="h-16 w-16 text-teal-300 mx-auto mb-4" />
